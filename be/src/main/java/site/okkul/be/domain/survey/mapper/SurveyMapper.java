...
public class SurveyMapper {
     ...
     * @param userId 유저 ID
     * @param request SurveyCreateRequest
     * @return Survey
     */
    public Survey toEntity(Long userId, SurveyCreateRequest request) {
        ...
        if (request.getHasJob() != null &&request.getHasJob()) {
			if (request.getManager() != null && request.getManager()) {
        ...
        // 규칙 2: 학생 여부
        if (request.getStudent() != null && request.getStudent()) {
        ...
        return Survey.builder()
                ...
                .teachAt(TeachingLevel.fromValue(request.getTeachAnswerId()))
    ...
    public SurveyResponse toResponseDto(Survey survey, List<TopicCategory> topicCategories) {
        ...
        return SurveyResponse.builder()
                ...
                .classType(survey.getClassType() != null ? survey.getClassType().toString() : null)
