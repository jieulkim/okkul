...
import site.okkul.be.infra.ai.dto.exam.ExamTotalRequest;
...
public class FakeAiClient implements AiClient {
	...
	@Override
	public QuestionAnalysisResponse analyzeQuestion(QuestionAnalysisRequest request) {
	...
	@Override
	public ExamTotalAnalysisResponse analyzeTotalExam(List<AnswerSummaryDto> request) {
		// 간단한 Mock 응답 반환
		return new ExamTotalAnalysisResponse(
				"IH", // predictedLevel
				83,   // totalScore
